...
layout: default
toc_levels: 1234
title: "OpenVox 8.25 Release Notes"
---

This page lists the links to the changes in OpenVox 8.25 and its patch releases. You can also view [known issues](known_issues.html) in this release.
